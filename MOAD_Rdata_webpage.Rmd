...
This page contains full statistical result of the paper <span style="font-weight:bold;">"MOAD: Modeling Observation-based Approximate Depedency"</span>, published on the 19th IEEE international Working Conference on Source Code Analysis and Manipulation (SCAM 2019).
